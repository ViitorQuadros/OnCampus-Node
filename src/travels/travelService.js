...
class TravelService{
    ...
    createTravels({ user, idViagem, nameViagem, voltoInViagem, vouInViagem, vouAndVoltoInViagem, destinoViagem}){
        const newTravels = new Travel({user, idViagem, nameViagem, voltoInViagem, vouInViagem, vouAndVoltoInViagem, destinoViagem})
